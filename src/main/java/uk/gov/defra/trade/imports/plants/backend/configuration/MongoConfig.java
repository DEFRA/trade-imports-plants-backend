package uk.gov.defra.trade.imports.plants.backend.configuration;
...
import uk.gov.defra.trade.imports.plants.backend.configuration.tls.TrustStoreConfiguration;

/**
 * MongoDB configuration for Trade Imports Plants Backend.
 *
