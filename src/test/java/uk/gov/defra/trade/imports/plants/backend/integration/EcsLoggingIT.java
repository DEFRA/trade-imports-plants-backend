package uk.gov.defra.trade.imports.plants.backend.integration;
...
/**
 * Integration test for ECS (Elastic Common Schema) structured logging. Verifies that logs are in
 * JSON format with all required CDP fields.
 */
